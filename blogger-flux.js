...
(function () {
  ...
  var DEFAULTS = {
    ...
    adlinkfly_domain:            'https://short2links.ct.ws',   // مثال: 'https://short2links.ct.ws'
    adlinkfly_api_key:           '0d373cad3c8f1f4b039120783e9be1aa5f0249b1',   // مفتاح API من /admin/api
    ...
    btn_img_1:  'https://blogger.googleusercontent.com/img/b/R29vZXR0bGVk/img/IM-NOT-ROBOT.png',  // صورة زر IM NOT ROBOT
    btn_img_2:  'https://blogger.googleusercontent.com/img/b/R29vZXR0bGVk/img/CLICK-2X.png',  // صورة زر CLICK 2X
    btn_img_3:  'https://blogger.googleusercontent.com/img/b/R29vZXR0bGVk/img/PLEASE-WAIT.png',  // صورة PLEASE WAIT
    btn_img_4:  'https://blogger.googleusercontent.com/img/b/R29vZXR0bGVk/img/DOWNLOAD-LINK.png',  // صورة زر DOWNLOAD LINK
  ...
  function onTimerCompleted() {
    ...
    if (CFG.scroll_to_instruction_on_load) smoothScroll(generateEl || wait1);
  }
  ...
  function restoreState() {
    ...
    if (saved.step === 'timer' && saved.countRemaining && saved.countRemaining > 0) {
      ...
      show(wait1El); hide(timerCtEl); hide(generateEl); hide(glc);
      startTimer();
      ...
      hide(wait1El); hide(timerCtEl); show(generateEl);
      show(glc);
    } else {
      show(robotEl);
    }
